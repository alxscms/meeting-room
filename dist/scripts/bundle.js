...
},{"core-js/fn/regexp/escape":6,"core-js/shim":299,"regenerator-runtime/runtime":323}],2:[function(require,module,exports){
...
},{"backbone":4,"backbone.radio":3,"underscore":324}],3:[function(require,module,exports){
...
},{"backbone":4,"underscore":324}],4:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
...
},{"jquery":320,"underscore":5}],5:[function(require,module,exports){
//     Underscore.js 1.8.3
...
},{"./handlebars/base":301,"./handlebars/exception":304,"./handlebars/no-conflict":314,"./handlebars/runtime":315,"./handlebars/safe-string":316,"./handlebars/utils":317}],301:[function(require,module,exports){
'use strict';
...
},{"./decorators":302,"./exception":304,"./helpers":305,"./logger":313,"./utils":317}],302:[function(require,module,exports){
'use strict';
...
},{"./decorators/inline":303}],303:[function(require,module,exports){
'use strict';
...
},{"../utils":317}],304:[function(require,module,exports){
'use strict';
...
},{"./helpers/block-helper-missing":306,"./helpers/each":307,"./helpers/helper-missing":308,"./helpers/if":309,"./helpers/log":310,"./helpers/lookup":311,"./helpers/with":312}],306:[function(require,module,exports){
'use strict';
...
},{"../utils":317}],307:[function(require,module,exports){
'use strict';
...
},{"../exception":304,"../utils":317}],308:[function(require,module,exports){
'use strict';
...
},{"../utils":317}],310:[function(require,module,exports){
'use strict';
...
},{"../utils":317}],313:[function(require,module,exports){
'use strict';
...
},{"./base":301,"./exception":304,"./utils":317}],316:[function(require,module,exports){
...
},{"./dist/cjs/handlebars.runtime":300}],319:[function(require,module,exports){
module.exports = require("handlebars/runtime")["default"];

},{"handlebars/runtime":318}],320:[function(require,module,exports){
/*!
...
},{"dup":5}],325:[function(require,module,exports){
"use strict";
...
var _layout = require("./lib/components/layout/layout");
...
},{"./lib/components/layout/layout":336,"backbone":4,"backbone.marionette":2}],326:[function(require,module,exports){
"use strict";
...
exports.default = _backbone2.default.Object.extend({
  initialize: function initialize() {
    this.layout = new _list_view.LayoutView();
    _app2.default.layout.showChildView("appRegion", this.layout);

    var eventCollection = _event2.default.getUpcomingEvents();
  ...
  nowRegion: function nowRegion() {
    this.nowView = new _list_view.NowView();
    this.layout.showChildView("nowRegion", this.nowView);
  },
  eventsRegion: function eventsRegion(collection) {
    this.eventCollectionView = new _list_view.EventCollectionView({ collection: collection });
...
},{"../../../app":325,"../../../entities/event":334,"./list_view":327,"backbone.marionette":2}],327:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.EventCollectionView = exports.EventView = exports.NoEventView = exports.NowView = exports.TimeView = exports.LayoutView = undefined;

var _view = require("../../../lib/views/view");

var _view2 = _interopRequireDefault(_view);

var _collection_view = require("../../../lib/views/collection_view");

var _collection_view2 = _interopRequireDefault(_collection_view);
...
var LayoutView = exports.LayoutView = _view2.default.extend({
...
var TimeView = exports.TimeView = _view2.default.extend({
...
var NowView = exports.NowView = _view2.default.extend({
...
var NoEventView = exports.NoEventView = _view2.default.extend({

  template: require("./templates/no_event.hbs")

});

var EventView = exports.EventView = _view2.default.extend({
  ...
  updateProgress: function updateProgress() {
    var maxHeight = this.getUI("progressContainer").height();
    var minHeight = this.getUI("progressContainer").width();
    var progress = this.model.getProgress();
    var height = minHeight + (maxHeight - minHeight) * progress;
...
var EventCollectionView = exports.EventCollectionView = _collection_view2.default.extend({
...
},{"../../../lib/views/collection_view":339,"../../../lib/views/view":340,"./templates/event.hbs":328,"./templates/layout.hbs":329,"./templates/no_event.hbs":330,"./templates/now.hbs":331,"./templates/time.hbs":332,"moment":321}],328:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3=container.escapeExpression;

  return "<div class=\"event-time\">\n    <span class=\"event-time-from\">"
    + alias3((helpers.presentTime || (depth0 && depth0.presentTime) || alias2).call(alias1,((stack1 = (depth0 != null ? depth0.start : depth0)) != null ? stack1.dateTime : stack1),{"name":"presentTime","hash":{},"data":data}))
    + "</span>\n    <span class=\"event-time-to\">"
    + alias3((helpers.presentTime || (depth0 && depth0.presentTime) || alias2).call(alias1,((stack1 = (depth0 != null ? depth0.end : depth0)) != null ? stack1.dateTime : stack1),{"name":"presentTime","hash":{},"data":data}))
    + "</span>\n</div>\n<div class=\"event-name\">"
    + alias3((helpers.sentenceCase || (depth0 && depth0.sentenceCase) || alias2).call(alias1,(depth0 != null ? depth0.summary : depth0),{"name":"sentenceCase","hash":{},"data":data}))
    + "</div>\n<div class=\"event-progress\"><div></div></div>\n<!--\n<div class=\"event event-free event-next\">\n    <div class=\"event-time\">\n        <span class=\"event-time-from\">12:30</span>\n        <span class=\"event-time-to\">14:00</span>\n    </div>\n    <div class=\"event-name\">Salle libre</div>\n    <div class=\"event-progress\"></div>\n</div>-->\n";
},"useData":true});

},{"hbsfy/runtime":319}],329:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"time-region\"></div>\n<div class=\"now-region\"></div>\n<div class=\"events-region\"></div>";
},"useData":true});

},{"hbsfy/runtime":319}],330:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":319}],331:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return container.escapeExpression((helpers.presentTime || (depth0 && depth0.presentTime) || helpers.helperMissing).call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.time : depth0),{"name":"presentTime","hash":{},"data":data}));
},"useData":true});

},{"hbsfy/runtime":319}],333:[function(require,module,exports){
"use strict";
...
var _list_controller = require("./list/list_controller");

var _list_controller2 = _interopRequireDefault(_list_controller);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MainRouter = _backbone2.default.AppRouter.extend({
...
},{"../../app":325,"./list/list_controller":326,"backbone.marionette":2}],334:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.EventCollection = exports.Event = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _model = require("../lib/entities/model");

var _model2 = _interopRequireDefault(_model);

var _collection = require("../lib/entities/collection");
...
var Event = exports.Event = _model2.default.extend({
  isPast: function isPast() {
    var end = this.get("end").dateTime;
    return (0, _moment2.default)().isAfter(end);
  },
  isHappeningNow: function isHappeningNow() {
    var start = this.get("start").dateTime;
    var end = this.get("end").dateTime;
    return (0, _moment2.default)().isBetween(start, end);
  },
  getProgress: function getProgress() {
    if (this.isHappeningNow()) {
      var start = (0, _moment2.default)(this.get("start").dateTime).unix();
      var end = (0, _moment2.default)(this.get("end").dateTime).unix();
...
var EventCollection = exports.EventCollection = _collection2.default.extend({
  ...
  parse: function parse(response) {
    ...
    for (var i in response) {
      ...
      if (i == 0) {
        if ((0, _moment2.default)().isBefore(event.start.dateTime)) {
          events.push(this.createFreeEvent((0, _moment2.default)().format(), event.start.dateTime));
        }
      } else {
        var previousEvent = response[i - 1];
        if ((0, _moment2.default)(previousEvent.end.dateTime).isBefore(event.start.dateTime)) {
...
var EventProvider = function () {
  ...
  _createClass(EventProvider, null, [{
...
},{"../lib/entities/collection":337,"../lib/entities/model":338,"moment":321}],335:[function(require,module,exports){
"use strict";
...
var _calendar = require("../../../config/google/calendar");

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var CalendarHelper = function () {
  function CalendarHelper() {
    _classCallCheck(this, CalendarHelper);
  }

  _createClass(CalendarHelper, [{
    key: "checkAuth",
    value: function checkAuth(callback) {
      var _this = this;

      gapi.auth.authorize({
        "client_id": _calendar.CLIENT_ID,
        "scope": _calendar.SCOPES.join(" "),
        "immediate": true
      }, function (authResult) {
        _this._handleAuthResult(authResult, callback);
      });
    }
  }, {
    key: "_handleAuthResult",
    value: function _handleAuthResult(authResult, callback) {
      var _this2 = this;
      ...
      if (authResult && !authResult.error) {
        ...
        gapi.auth.authorize({
          client_id: _calendar.CLIENT_ID,
          scope: _calendar.SCOPES,
          immediate: false
        }, function (authResult) {
          _this2._handleAuthResult(authResult, callback);
        });
      }
    }
  }, {
    key: "_loadCalendarApi",
    value: function _loadCalendarApi(callback) {
...
exports.default = new CalendarHelper();

},{"../../../config/google/calendar":341}],336:[function(require,module,exports){
"use strict";
...
},{"backbone.marionette":2}],337:[function(require,module,exports){
"use strict";
...
var _calendar = require("../../entities/helpers/calendar");

var _calendar2 = _interopRequireDefault(_calendar);

var _calendar3 = require("../../../config/google/calendar");
...
exports.default = _backbone2.default.Collection.extend({
  sync: function sync(method, model, options) {
    _calendar2.default.checkAuth(function () {
      var request = gapi.client.calendar.events.list({
        "calendarId": _calendar3.CALENDAR_ID || "primary",
        "timeMin": (0, _moment2.default)().hours(0).minutes(0).format(),
        "timeMax": (0, _moment2.default)().hours(23).minutes(59).format(),
        "showDeleted": false,
        "singleEvents": true,
        "orderBy": "startTime"
      });
...
},{"../../../config/google/calendar":341,"../../entities/helpers/calendar":335,"backbone":4,"moment":321}],338:[function(require,module,exports){
"use strict";
...
},{"backbone":4}],339:[function(require,module,exports){
"use strict";
...
},{"backbone.marionette":2}],340:[function(require,module,exports){
"use strict";
...
exports.default = _backbone2.default.View.extend({
  emptyRegions: function emptyRegions() {
    ...
    var regions = _underscore2.default.keys(this.regions);
    _underscore2.default.each(regions, function (region) {
      _this.getRegion(region).empty();
    });
  }
});

},{"backbone.marionette":2,"underscore":324}],341:[function(require,module,exports){
"use strict";
...
var CLIENT_ID = exports.CLIENT_ID = "318041293364-b2mdbi7onss1srf7t4tqgnqjkqp8vfjb.apps.googleusercontent.com";

// your google calendar id or primary
var CALENDAR_ID = exports.CALENDAR_ID = "critizr.com_ssuvdrchpjf49v886aug8h4bdk@group.calendar.google.com";

var SCOPES = exports.SCOPES = ["https://www.googleapis.com/auth/calendar.readonly"];
...
function presentTime(date, options) {
  var parsedDate = (0, _moment2.default)(date);
  return parsedDate.format("HH:mm");
}

_runtime2.default.registerHelper("presentTime", presentTime);

},{"hbsfy/runtime":319,"moment":321}],343:[function(require,module,exports){
"use strict";
...
_runtime2.default.registerHelper("sentenceCase", function () {
...
},{"hbsfy/runtime":319}],344:[function(require,module,exports){
"use strict";

require("babel-polyfill");

var _app = require("./backbone/app");
...
window.next = function () {
  var $currentEvent = (0, _jquery2.default)(".event:not(.event-next,.event-past)");
  var $nextEvent = (0, _jquery2.default)(".event-next").first();
  $currentEvent.addClass("event-past");
  $nextEvent.removeClass("event-next");
};

},{"./backbone/app":325,"./backbone/apps/main/main_app":333,"./handlebars/helpers/presenters/present_time":342,"./handlebars/helpers/sentence_case":343,"babel-polyfill":1,"backbone":4,"backbone.marionette":2,"jquery":320}]},{},[344])
